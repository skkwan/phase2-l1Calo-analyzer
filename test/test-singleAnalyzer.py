...
#                            '/store/mc/Phase2Spring23DIGIRECOMiniAOD/VBFHToTauTau_M-125_TuneCP5_14TeV-powheg-pythia8/GEN-SIM-DIGI-RAW-MINIAOD/PU200_Trk1GeV_131X_mcRun4_realistic_v5-v1/30000/00a27704-5eb4-4b20-81de-8af0d9f09645.root',),
                            'file:DoubleElectron_FlatPt-1To100-gun-Phase2Spring23DIGIRECOMiniAOD.root'),
###Victor
...
#process.source.eventsToProcess = cms.untracked.VEventRange("1:26907")
...
process.pL1EG = cms.Path( process.l1tPhase2L1CaloEGammaEmulator * process.l1tEGammaClusterEmuProducer * process.l1tPhase2CaloPFClusterEmulator * process.l1tPhase2GCTBarrelToCorrelatorLayer1Emulator * process.l1NtupleSingleProducer)
